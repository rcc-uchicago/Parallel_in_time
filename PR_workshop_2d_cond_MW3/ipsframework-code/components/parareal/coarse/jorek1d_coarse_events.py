...
#                                 '1', '192', '192', '100', '100'])
        ...
        plot_out = 'coarse_plot_profile.%s' % (self.suffix)
        args = [values_input, deltas_input, values_out, deltas_out, plot_out, self.comp.TOTAL_STEPS, self.comp.STEP_WIDTH, self.comp.N_PLOT]
...
#                raise
        ...
        numlines = len(open(my_out['COARSE_OUT_DELTAS']).readlines())
        cmd = [correction_bin, 
