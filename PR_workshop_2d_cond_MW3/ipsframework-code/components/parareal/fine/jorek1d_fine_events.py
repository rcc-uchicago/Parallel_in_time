...
class FineTask(object):
    ...
    def prepare_input(self, c2f_bin = None, f2c_bin = None, correction_bin = None):
        ...
        if (self.iter == 1 or self.first_in_slice):
            fine_in_values = 'fine_in_values.' + self.suffix
        ...
        plot_out = 'fine_plot_profile.%s' % (self.suffix)
        args = [fine_in_values, fine_in_deltas, fine_out_values, fine_out_deltas, 
                plot_out, self.comp.TOTAL_STEPS, self.comp.STEP_WIDTH, self.comp.N_PLOT]
