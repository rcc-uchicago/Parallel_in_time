...
class ConvergeTask(object):
    ...
    def prepare_input(self):
        ...
        if (fine_in_cur_iter and fine_in_prev_iter):
            prev_iter_values = fine_in_prev_iter['FINE_OUT_VALUES']
            cur_iter_values = fine_in_cur_iter['FINE_OUT_VALUES']
            converge_out = 'converge_out.' + self.suffix
            num_lines = len(open(cur_iter_values).readlines())
            self.submit_args = [prev_iter_values, cur_iter_values, converge_out, str(num_lines)]
